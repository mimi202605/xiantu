...
- 装备增幅: object (可选，属性加成对象)
  - 格式: {"后天六司": {"体质": 2, "直觉": 1}, "气血上限": 50, "灵气上限": 30}
  - 后天六司: object (可选，六司加成)
  - 气血上限: number (可选)
  - 灵气上限: number (可选)
  - 神识上限: number (可选)
...
**示例 - 正确做法：**
\`\`\`json
{"action":"set", "key":"社交.关系.张三", "value":{"名字":"张三","性别":"男","年龄":25,"出生日期":{"年":975,"月":3,"日":15},"种族":"人族","出生":"散修","外貌描述":"...","性格特征":["..."],"境界":{"名称":"筑基","阶段":"初期"},"灵根":{"名称":"火灵根","品级":"中品"},"天赋":[],"先天六司":{"体质":5,"直觉":6,"悟性":5,"气运":4,"魅力":5,"心性":6},"属性":{"气血":{"当前":1000,"上限":1000},"灵气":{"当前":800,"上限":800},"神识":{"当前":400,"上限":400},"寿元上限":200},"与玩家关系":"陌生人","好感度":0,"人格底线":["..."],"记忆":[],"记忆总结":[],"当前位置":{"描述":"...","x":5000,"y":5000},"势力归属":"无","当前外貌状态":"...","当前内心想法":"...","背包":{"灵石":{"下品":0,"中品":0,"上品":0,"极品":0},"物品":{}},"实时关注":false}}
\`\`\`
...
**【藏经阁/贡献商店动态生成】**
玩家首次访问藏经阁或贡献商店时，AI 需要根据宗门特色动态生成内容：
