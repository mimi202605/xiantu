...
|-------------|--------|--------|--------|
| 战斗攻击 Attack | 体质 | 直觉 | 气运 |
| 战斗防御 Defense | 体质 | 心性 | 直觉 |
| 炼丹炼器 Alchemy | 悟性 | 直觉 | 心性 |
| 修炼突破 Cultivation | 悟性 | 直觉 | 心性 |
| 探索发现 Explore | 气运 | 直觉 | 悟性 |
| 社交说服 Social | 魅力 | 悟性 | 心性 |
| 躲避逃跑 Escape | 直觉 | 气运 | 体质 |
...
## 战斗伤害
\`基础伤害=(体质+直觉)×境界系数+武器伤害\`
\`实际伤害=基础伤害-(对方体质+护甲)×境界系数\`
